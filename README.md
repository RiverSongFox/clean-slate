...
[![ko-fi](https://ko-fi.com/img/githubbutton_sm.svg)](https://ko-fi.com/W7W8EOXO9)
...
```
## Deploying to the web with [surge](https://surge.sh/)
...
```bash
npm run build
surge public clean-slate.surge.sh
```
